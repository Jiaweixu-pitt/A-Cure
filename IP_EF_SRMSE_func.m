function [str_Acc, str_RMSE_clean_hfuse, str_RMSE_clean_LSQ,...
...
current_method = 'IP_EF_SRMSE';
% setting up output folder
output_folder = strcat(pwd,'\outPut\',current_method,'\');
